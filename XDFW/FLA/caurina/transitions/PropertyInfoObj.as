package caurina.transitions
{
    ...
    public class PropertyInfoObj extends Object
    {
        ...
        {
            var _loc_1:PropertyInfoObj;
            _loc_1 = new PropertyInfoObj(valueStart, valueComplete, originalValueComplete, arrayIndex, extra, isSpecialProperty, modifierFunction, modifierParameters);
            return _loc_1;
        }// end function
